...
class AnalyticsImportService:
    ...
    HEADER_ALIASES = {
        ...
        "likes": {"likes", "like count", "高評価", "高評価数", "いいね", "いいね数"},
        ...
        "watch_time_hours": {"watch time (hours)", "watch time hours", "総再生時間", "総再生時間（時間）", "総再生時間（単位: 時間）", "再生時間（時間）"},
        "average_view_duration": {"average view duration", "平均視聴時間", "平均再生時間"},
        "average_percentage_viewed": {"average percentage viewed", "平均再生率", "平均視聴率", "平均視聴率 (%)"},
        "impressions": {"impressions", "表示回数", "インプレッション", "インプレッション数"},
        "ctr": {"impressions click-through rate (%)", "ctr", "クリック率", "インプレッションのクリック率", "インプレッションのクリック率 (%)"},
        "subscriber_change": {"subscribers", "subscriber change", "登録者", "登録者増減", "チャンネル登録者"},
